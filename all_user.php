...
?>   
               ...
               <!--MSK-000115-td2--><td id="td2_<?php echo $row['id']; ?>"><?php echo $row['type']; ?></td>
...
echo '<a href="#modalUpdateform" id="edit_sfee_'.$count.'" onClick="showModal(this)" class="btn btn-info btn-xs" data-id="'.$sr_id.','.$count.'" data-toggle="modal">Edit User</a>';        
...
//MSK-000126
	...
	var table_name1= "user";//give data table name
    		...
    		if (this.readyState == 4 && this.status == 200) {
				...
				if(myArray[0]==1){//MSK-000130
					...
					var xhttp1 = new XMLHttpRequest();//MSK-000131-Start Ajax  
						...
						xhttp1.open("GET", "show_user_table.php" , true);												
   ...
   xhttp.open("GET", "../model/delete_user.php?id=" + id + "&do="+do1 + "&table_name="+table_name1 + "&page="+currentPage , true);												
